...
#define LEDBUTTON_BUTTON_PIN            1                                /**< Button that will trigger the notification event with the LED Button Service */
#define AS608_PS_STA_PIN				BUTTON_START
...
static void button_event_handler(uint8_t pin_no, uint8_t button_action)
{
    ...
    switch (pin_no)
    {
        case LEDBUTTON_BUTTON_PIN:
			#if defined(NRF_LOG_USES_RTT) && NRF_LOG_USES_RTT == 1
				SEGGER_RTT_printf(0,"LEDBUTTON_BUTTON_PIN:%d\r\n",button_action);
			#endif
			NRF_LOG_RAW_INFO("LEDBUTTON_BUTTON_PIN:%d\r\n",button_action);
		...
		case AS608_PS_STA_PIN:
		{
			//NRF_LOG_INFO("Send button state change.\r\n"); 
			#if defined(NRF_LOG_USES_RTT) && NRF_LOG_USES_RTT == 1
				SEGGER_RTT_printf(0,"%d:AS608_PS_STA_PIN:%d\r\n",NRF_RTC1->COUNTER, button_action);
			#endif
			//NRF_LOG_INFO("%d:AS608_PS_STA_PIN:%d\r\n",NRF_RTC1->COUNTER, button_action);
			NRF_LOG_RAW_INFO("%d:AS608_PS_STA_PIN:%d\r\n",NRF_RTC1->COUNTER, button_action);			
