...
#ifndef PTR9618PA
#define  OLED_DC     				17   //OLED命令/数据选择 H=命令 L=数据
#define  OLED_CS     				18   //OLED片选
#define  OLED_RST    				19   //OLED复位
#define  OLED_EN	 				20
...
#define SPI0_CONFIG_IRQ_PRIORITY    _PRIO_APP_LOWEST
#define SPI_INSTANCE  				0 /**< SPI instance index. */
#define SPI_CS_PIN    				18  /**< SPI CS Pin.*/
...
#define SPI0_CONFIG_MISO_PIN        27
#define SPI0_CONFIG_IRQ_PRIORITY    _PRIO_APP_LOWEST
#define SPI_INSTANCE  				0 /**< SPI instance index. */
#define SPI_CS_PIN    				28  /**< SPI CS Pin.*/
#define SPI0_INSTANCE_INDEX 		0
#endif
